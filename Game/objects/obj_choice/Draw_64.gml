...
draw_text_transformed(cx / 2, gh / 2, "Ficar até mais tarde", scale_l, scale_l, 0);
draw_text_transformed(cx + cx / 2, gh / 2, "Ir pro aniversário de um amigo", scale_r, scale_r, 0);
